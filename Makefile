#############################################################################
# Makefile for building: LookServer
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  LookServer.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile LookServer.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -m64
LIBS          = $(SUBLIBS) -lpthread -levent -levent_pthreads 
AR            = ar cqs
RANLIB        = 
...
Makefile: LookServer.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/lex.prf \
		LookServer.pro
	$(QMAKE) -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile LookServer.pro
...
dist: 
	@test -d .tmp/LookServer1.0.0 || mkdir -p .tmp/LookServer1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/LookServer1.0.0/ && (cd `dirname .tmp/LookServer1.0.0` && $(TAR) LookServer1.0.0.tar LookServer1.0.0 && $(COMPRESS) LookServer1.0.0.tar) && $(MOVE) `dirname .tmp/LookServer1.0.0`/LookServer1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/LookServer1.0.0
...
workqueue.o: workqueue.cpp workqueue.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o workqueue.o workqueue.cpp
...
httpparser.o: httpparser.cpp httpparser.h \
		response.h \
		configuration.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o httpparser.o httpparser.cpp
